...
- **Tu propia voz, local y portable**: una persona puede conservar hasta cuatro carriles sin perder ninguno: **✨ Máxima (XTTS + restauración)**, **Calidad (XTTS residente)**, **⚖️ Equilibrada (Qwen3‑TTS sobre MLX, streaming local en Apple Silicon)** y **⚡ Rápida (Piper/ONNX)**. Máxima prioriza identidad; Calidad prioriza menor espera. La variante equilibrada usa una muestra+transcripción y arranca por chunks; el paquete portable lleva XTTS, referencia/configuración MLX y ONNX, mientras los motores comunes se instalan una sola vez. Piper se valida antes de activar y su trabajo es reanudable tras cerrar la app o apagar la Mac
...
| `agente_rutinas.json` | Rutinas creadas por el usuario |
