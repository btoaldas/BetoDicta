...
- **Modos — decide qué hacer con lo dictado**: además de **Dictado** (pulir), elige **Correo, Oficio, Tarea, Nota, Traducir, Asistente** o **Buscar** — cada modo con su propia IA, prompt y color. Cámbialo al vuelo desde el notch o por voz: *"modo agente"* cambia el notch mientras hablas; una pausa configurable (2 s por defecto) confirma el comando sin detener la grabación. La detección exacta/difusa/semántica está aislada por dictado, conserva argumentos (*"traducir quichua"*, *"buscar Wikipedia"*) y evita falsos positivos comunes. También puede activarse **por app** o **sitio web**. El modo al vuelo puede ser de un solo uso y puedes crear tus **propios** modos.
