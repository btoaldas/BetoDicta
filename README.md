...
- **Tu propia voz, local y portable**: una persona puede conservar tres carriles sin perder ninguno: **Calidad (XTTS)**, **⚖️ Equilibrada (Qwen3‑TTS sobre MLX, streaming local en Apple Silicon)** y **⚡ Rápida (Piper/ONNX)**. La variante equilibrada usa una muestra+transcripción y arranca por chunks; el paquete portable lleva su referencia/configuración, mientras el modelo común se descarga una sola vez. Piper se valida antes de activar y su trabajo es reanudable tras cerrar la app o apagar la Mac
