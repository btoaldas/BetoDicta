...
enum ModoAudioQA {
    ...
    static func ejecutarSiSePidio() {
        ...
        let matriz = [
            ...
            Caso(frase: "Abre Gmail y escribe un correo para prueba arroba ejemplo punto com: necesitamos preparar el programa del evento.",
                 transforms: ["correo"], acciones: ["gmail"], negativo: false,
                 contiene: "necesitamos preparar", destinatario: "prueba@ejemplo.com"),
