...
enum ModoAudioQA {
    ...
    static func ejecutarSiSePidio() {
        ...
        let matriz = [
            ...
            Caso(frase: "Oye, Bto, crea una redacción de un verso sin esfuerzo, algo simpático, y después mándaselo a Alberto por WhatsApp.",
                 transforms: ["generar"], acciones: ["whatsapp"], negativo: false,
                 contiene: "redacción de un verso", destinatario: "Alberto"),
