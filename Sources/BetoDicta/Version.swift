...
enum Version {
    ...
    static let historial: [(version: String, fecha: String, cambios: [String])] = [
        ("0.44.0", "2026-07-18", [
            ...
            "MODO MÚSICA CON FAILOVER: Apple Music espera su arranque en frío y confirma audio real; Spotify reproduce el primer resultado visible y verificado; buscar nunca pulsa Play; la cascada continúa si un motor solo logra abrir resultados y conserva un Atajo firmado como puente opcional",
