...
**Cadenas coloquiales — varias acciones de una, hablando natural.** Di *"por favor, envía un correo que traduzca lo siguiente: …"* o *"tradúceme esto al inglés y mándalo por whatsapp: …"* — BetoDicta detecta las **múltiples intenciones** (da igual el orden en que las digas) y te confirma TODO de una en el notch: *"¿TRADUCIR al inglés y enviar por correo? fn = sí · clic = no"*. Pulsas **fn** y ejecuta la cadena completa: traduce y abre el correo con el resultado. Nunca ejecuta sin confirmarte.
