...
- **Voz del sistema (texto → voz)** (*Ajustes → Avanzado*): BetoDicta puede **leerte** respuestas en voz (voz de macOS, gratis y local). Es el primer paso del **Modo Agente** (que responda por voz a lo que le pidas). Eliges voz y velocidad, y hay un botón **"Probar voz"**.
