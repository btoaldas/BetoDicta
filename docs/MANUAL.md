...
**Tareas y notas** (pestaña propia): lo que dictas con Tarea/Nota se acumula ahí. Marca tareas como **hechas**, bórralas, **"Limpiar hechas"**, o agrega a mano. BetoDicta reconoce fechas dentro del texto (*"modo tarea llamar a Rafael mañana a las 8:00 p. m."*) o permite escogerlas manualmente. Cada ítem puede avisar una sola vez mediante una **notificación de macOS**, el notch y, de forma opcional, la voz TTS elegida; nunca habla durante una grabación de pantalla. Si la Mac estaba dormida o apagada, el aviso vencido se recupera al volver a abrir BetoDicta. En **Avisos y resúmenes** puedes apagar todo, elegir sonido/voz, incluir notas con fecha y configurar un resumen local por la mañana y otro por la tarde. Los resúmenes incluyen tareas de hoy, mañana, vencidas y —si quieres— las que aún no tienen fecha; no usan IA ni salen de la Mac. El **Calendario local** permite revisar un día y agregar un pendiente directamente. Los datos siguen en `~/.betodicta/pendientes.json` con permisos privados.

**Acciones a apps de Mac:** vienen creados modos de acción para Outlook, Correo, WhatsApp, **Nota de Apple**, Recordatorios, Calendario, Finder, Safari, Música, Terminal, Mapas, Spotlight y tu web. **Recordatorios y Calendario usan EventKit nativo**. **Nota de Apple** usa el diccionario oficial de automatización de Notas: crea el elemento, conserva párrafos/listas y vuelve a leerlo antes de anunciar éxito. La primera vez macOS puede pedir permiso en **Privacidad y seguridad → Automatización → BetoDicta → Notas**. Si el permiso falta o Notas falla, no finge éxito: abre Notas y deja todo el texto en el portapapeles. Esto es distinto de **Nota local de BetoDicta**, que se guarda únicamente en la pestaña Tareas y notas.
